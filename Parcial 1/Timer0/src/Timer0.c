//Este código marca un salto de nivel: pasamos de hacer retardos "manuales" (perdiendo tiempo con un for) a usar ...
//... el Timer 0, un periférico dedicado que cuenta el tiempo de forma precisa e independiente del procesador.
